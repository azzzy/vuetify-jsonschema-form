          ...
          <v-flex xs6>
            ...
            <v-form ref="myForm" v-model="formValid">
              <v-jsonschema-form
                ...
                :schema="schema"
                :model="dataObject"
                :options="{debug: true, targets: targets, disableAll: false, autoFoldObjects: true, context: {owner: {type: 'organization', id: '5a5dc47163ebd4a6f438589b'}}, accordionMode: 'normal'}"
